...
public class Lavacao {
    
    
      private JFrame janela, janelaSetor;
    private JPanel painelPrincipal, painelTabela, painelTipo1, painelTipo2, painelSetor;
    private JLabel lblData,lblCliente,lblCodCliente, lblCI, lblPrazo, lblDataVencimento,lblTipo,lblTotalParcial, lblMotorista, lblPlaca, lblFornecedor, lblQtdRoca, lblEscritorio, lblAdiantamento, lblTotalGeral;
    private JTextField txtCliente, txtCodCliente, txtCI, txtPrazo, txtTotalParcial, txtMotorista, txtCodMotorista, txtPlaca, txtFornecedor, txtCodFornecedor, txtQtdRoca, txtAdiantamento, txtTotalGeral;
    private JButton btnConsultaCliente,btnConsultaMotorista, btnConsultaFornecedor,btnCancelaTabela,btnAlterarTabela,btnExcluirTabela,btnGravaTabela, btnGravar, btnCancelar, btnConsultar, btnSair;
  ...
  public void desenharTela() throws ParseException {  
     janela = new JFrame("Lavação Venda");
     ...
     //--------------------------------------------------------------   
      ...
      //--------------------------------------------------------------
       ...
       btnConsultaCliente.setBounds(430, 30, 20, 20);       
      ...
      //--------------------------------------------------------------  
         lblCI = new JLabel("CI");
        lblCI.setBounds(460, 10, 120, 22);
        painelPrincipal.add(lblCI);
        
        txtCI = new JTextField();
        txtCI.setBounds(460, 30, 60, 22);
      ...
      //--------------------------------------------------------------
       ...
       painelPrincipal.add(btnConsultaMotorista);
        ...
        lblFornecedor.setBounds(430, 60, 80, 22);
        painelPrincipal.add(lblFornecedor);
        
        txtFornecedor = new JTextField();
        txtFornecedor.setBounds(430, 80, 250, 22);
        painelPrincipal.add(txtFornecedor);
      //--------------------------------------------------------------  
         
        txtCodFornecedor = new JTextField();
        txtCodFornecedor.setBounds(685, 80, 40, 22);
      ...
      //--------------------------------------------------------------
       ...
       btnConsultaFornecedor.setBounds(730, 80, 20, 22);       
       ...
       //----------------------------------------------------------------------------//
        ...
        lblQtdRoca = new JLabel("Qtd Roça ");
        lblQtdRoca.setBounds(760, 60, 80, 22);
        painelPrincipal.add(lblQtdRoca);
        
        txtQtdRoca = new JTextField();
        txtQtdRoca.setBounds(760, 80, 80, 22);
        painelPrincipal.add(txtQtdRoca);
        //----------------------------------------------------------------------------//
       ...
       painelTabela.add(btnExcluirTabela);
        ...
        painelTipo2.setLocation(680, 110);
