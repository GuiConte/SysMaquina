...
public class CadTabela_Centro {
    ...
    private JLabel lblCodigo, lblCentro;
    private JTextField txtCodigo, txtCentro;
    private JButton btnGravar,btnCancelar;
    
    
     public void desenharTela() {

        janela = new JFrame("Cadastro Centros");
     ...
     private void criarTabela() {
        ...
        tblCentro.setModel(modelo);
        tblCentro.getColumnModel().getColumn(0).setPreferredWidth(60);
        tblCentro.getColumnModel().getColumn(1).setPreferredWidth(237);
        

        tblCentro.getTableHeader().setResizingAllowed(false);
        tblCentro.getTableHeader().setReorderingAllowed(false);

        JTableHeader cabecalho = tblCentro.getTableHeader();
        ...
        tblCentro.getColumnModel().getColumn(0).setCellRenderer(centralizaColunas);
        tblCentro.getColumnModel().getColumn(1).setCellRenderer(centralizaColunas);
        

        tblCentro.setFont(new Font("Arial", 0, 11));

        scrollTable = new JScrollPane(tblCentro,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollTable.setBounds(10, 20, 300, 280);
        tblCentro.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    ...
    public void desenharTelaNovo(){
        ...
        lblCentro.setBounds(90, 10, 180, 22);
        painelNovo.add(lblCentro);
        
        txtCentro = new JTextField();
        txtCentro.setBounds(90, 30, 170, 22);
        painelNovo.add(txtCentro);
