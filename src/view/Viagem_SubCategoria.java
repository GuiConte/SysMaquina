...
import model.ViagemSubModel;


public class Viagem_SubCategoria {
    
    ViagemSubModel viagem;
    ...
    private JButton btnGravar,btnCancelar;
     ...
     public void desenharTela() {
        ...
        janela = new JFrame("Histórico de Despesas - SubCategoria");
  ...
  public model.ViagemSubModel getViagemSubCategoria(){
        
           viagem= new ViagemSubModel(txtRamo.getText());
