...
import model.TabProdutorModel;


public class CadTabela_Produtor {
    
    TabProdutorModel produtor;
    
    private JFrame janela,janelaNovo;
    private JPanel painelPrincipal, painelNovo;
    private JTable tblProdutor;
    private JScrollPane scrollTable;
    private DefaultTableModel modelo;
    private JButton btnNovo,btnAlterar,btnExcluir,btnSair;
    private JLabel lblCodigo, lblProdutor;
    private JTextField txtCodigo, txtProdutor;
    ...
    private JButton btnGravar,btnCancelar;
     ...
     public void desenharTela() {
        ...
        janela = new JFrame("Cadastro de Produtor");
     ...
     private void criarTabela() {
        ...
        tblProdutor = new JTable();
        tblProdutor.setModel(modelo);
        tblProdutor.getColumnModel().getColumn(0).setPreferredWidth(60);
        tblProdutor.getColumnModel().getColumn(1).setPreferredWidth(237);
        

        tblProdutor.getTableHeader().setResizingAllowed(false);
        tblProdutor.getTableHeader().setReorderingAllowed(false);

        JTableHeader cabecalho = tblProdutor.getTableHeader();
        ...
        tblProdutor.getColumnModel().getColumn(0).setCellRenderer(centralizaColunas);
        tblProdutor.getColumnModel().getColumn(1).setCellRenderer(centralizaColunas);
        

        tblProdutor.setFont(new Font("Arial", 0, 11));

        scrollTable = new JScrollPane(tblProdutor,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollTable.setBounds(10, 20, 300, 280);
        tblProdutor.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
     ...
     public void desenharTelaNovo(){
        ...
        lblProdutor.setBounds(90, 10, 180, 22);
        painelNovo.add(lblProdutor);
        
        txtProdutor = new JTextField();
        txtProdutor.setBounds(90, 30, 170, 22);
        painelNovo.add(txtProdutor);
       ...
       painelNovo.add(btnCancelar);
        ...
        public TabProdutorModel getCadTabela_Produtor(){
           ...
           produtor= new TabProdutorModel(txtProdutor.getText(),
           ativo);
