...
public class Cheque_Entrada {
    ...
    private JLabel lblCliente, lblNumeroCI, lblContaCheque, lblDataDestino, lblStatus, lblReferencia,lblSequencia, lblVersoCheque, lblObservacao;
    private JTextField txtCliente, txtCodCliente, txtNumeroCI, txtReferencia,txtSequencia;
    private JButton btnConsultaCliente, btnGravar, btnConsultar, btnSair, btnCancelar;
    private JComboBox cbContaCheque, cbStatus;
    private JCheckBox cbFixo;
    private JFormattedTextField txtData, txtDataDestino, txtBom;
     ...
     private JScrollPane scrollObs;
      ...
      public void desenharTela() throws ParseException {  
        janela = new JFrame("Cadastro de Cheque");
   ...
   //----------------------------------------------------------------------------------//
     ...
     //----------------------------------------------------------------------------------//  
        ...
        painelCliente.add(txtCodCliente);
           ...
           cbFixo = new JCheckBox("Fixo");
        cbFixo.setBounds(80, 20, 100, 20);
        painelCliente.add(cbFixo);
   //----------------------------------------------------------------------------------//
   ...
   //----------------------------------------------------------------------------------//
    ...
    //----------------------------------------------------------------------------------//  
         ...
         lblNumeroCI = new JLabel("Número C.I ");
        lblNumeroCI.setBounds(380, 120, 120, 22);
        painelPrincipal.add(lblNumeroCI);
        
        txtNumeroCI = new JTextField();
        txtNumeroCI.setBounds(380, 140, 80, 22);
        painelPrincipal.add(txtNumeroCI);
   ...
   //----------------------------------------------------------------------------------//
    ...
    //----------------------------------------------------------------------------------//  
         ...
         lblContaCheque = new JLabel("Conta Cheque ");
        lblContaCheque.setBounds(480, 120, 120, 22);
        painelPrincipal.add(lblContaCheque);
        
        cbContaCheque = new JComboBox();
        cbContaCheque.setBounds(480, 140, 200, 22);
        painelPrincipal.add(cbContaCheque);
