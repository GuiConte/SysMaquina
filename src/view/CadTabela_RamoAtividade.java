...
public class CadTabela_RamoAtividade {
    ...
    private JButton btnGravar,btnCancelar;
     ...
     public void desenharTela() {
        ...
        janela = new JFrame("Cadastro de Categoria/Ramo de Atividade");
     ...
     private void criarTabela() {
        ...
        modelo.addColumn("Categoria/Ramo de Atividade");
     

        tblRamoAtividade = new JTable();
        tblRamoAtividade.setModel(modelo);
        tblRamoAtividade.getColumnModel().getColumn(0).setPreferredWidth(60);
        tblRamoAtividade.getColumnModel().getColumn(1).setPreferredWidth(237);
        

        tblRamoAtividade.getTableHeader().setResizingAllowed(false);
        tblRamoAtividade.getTableHeader().setReorderingAllowed(false);

        JTableHeader cabecalho = tblRamoAtividade.getTableHeader();
        ...
        tblRamoAtividade.getColumnModel().getColumn(0).setCellRenderer(centralizaColunas);
        tblRamoAtividade.getColumnModel().getColumn(1).setCellRenderer(centralizaColunas);
        

        tblRamoAtividade.setFont(new Font("Arial", 0, 11));

        scrollTable = new JScrollPane(tblRamoAtividade,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollTable.setBounds(10, 20, 300, 280);
        tblRamoAtividade.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
     ...
     public void desenharTelaNovo(){
        ...
        lblRamo = new JLabel("Categoria / Ramo de Atividade ");
