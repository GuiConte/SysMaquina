...
public class Compra_Cebola {
    ...
    private JTextField  txtFornecedor, txtCodFornecedor, txtCI, txtProduto,txtCodProduto, txtQuantidade, txtValorUnitario,txtVlrReajustado, txtValorTotal, txtPrecoMinimo, txtObservacao, txtPrazo, txtDesconto, txtAdiantamento, txtTotal;
    ...
    private JLabel lblDados, lblChapa, lblLavacao, lblFreteRoca, lblOutras, lblPesoInicial, lblPesoFinal;
    private JTextField txtChapa, txtLavacao, txtFreteRoca, txtOutras, txtPesoInicial, txtPesoFinal;
    private JButton btnDados;
    
      public void desenharTela() throws ParseException {

        janela = new JFrame("Compra Cebola");
       ...
       //--------------------------------------------------------------------//
        ...
        txtObservacao.setBounds(410, 420, 200, 150);
   ...
   //-------------------------------------------------------------------------------------------// 
     ...
     private void criarDadosComplementar() {
      ...
      //------------------------------------------------------------------------//
        ...
        lblPesoInicial = new JLabel("Peso Inicial ");
        lblPesoInicial.setBounds(170, 40, 100, 22);
        painelDados.add(lblPesoInicial);
        
       
        txtPesoInicial = new JTextField();
        txtPesoInicial.setBounds(170, 60, 100, 22);
        painelDados.add(txtPesoInicial);
      
        
           //------------------------------------------------------------------------//
      
        lblPesoFinal = new JLabel("Peso Final ");
        lblPesoFinal.setBounds(170, 80, 100, 22);
        painelDados.add(lblPesoFinal);
        
       
        txtPesoFinal = new JTextField();
        txtPesoFinal.setBounds(170, 100, 100, 22);
        painelDados.add(txtPesoFinal);
