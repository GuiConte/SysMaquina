...
import model.HistoricoChequeModel;



public class CadTabela_HistoricoCheque {
    
    HistoricoChequeModel cheque;
    ...
    private JButton btnGravar,btnCancelar;
     ...
     public void desenharTela() {
        ...
        janela = new JFrame("Histórico de Cheque");
     ...
     private void criarTabela() {
        ...
        tblCheque.getColumnModel().getColumn(0).setPreferredWidth(60);
        tblCheque.getColumnModel().getColumn(1).setPreferredWidth(237);
    ...
    public void desenharTelaNovo(){
      ...
      // ---------------- BOTAO GRAVAR-----//
       ...
       painelNovo.add(btnCancelar);
        ...
        public HistoricoChequeModel getCadTabela_HistCheque(){
        
           cheque= new HistoricoChequeModel(txtDescricao.getText());
