...
public class CadTabela_Vendedor {
    ...
    private JTable btlVendedor;
    private JScrollPane scrollTable;
    private DefaultTableModel modelo;
    private JButton btnNovo,btnAlterar,btnExcluir,btnSair;
      private JLabel lblCodigo, lblVendedor;
    private JTextField txtCodigo, txtVendedor;
    private JButton btnGravar,btnCancelar;
     ...
     public void desenharTela() {
        ...
        janela = new JFrame("Cadastro de Vendedores");
     ...
     private void criarTabela() {
        ...
        btlVendedor = new JTable();
        btlVendedor.setModel(modelo);
        btlVendedor.getColumnModel().getColumn(0).setPreferredWidth(60);
        btlVendedor.getColumnModel().getColumn(1).setPreferredWidth(237);
        

        btlVendedor.getTableHeader().setResizingAllowed(false);
        btlVendedor.getTableHeader().setReorderingAllowed(false);

        JTableHeader cabecalho = btlVendedor.getTableHeader();
        ...
        btlVendedor.getColumnModel().getColumn(0).setCellRenderer(centralizaColunas);
        btlVendedor.getColumnModel().getColumn(1).setCellRenderer(centralizaColunas);
        

        btlVendedor.setFont(new Font("Arial", 0, 11));

        scrollTable = new JScrollPane(btlVendedor,JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        scrollTable.setBounds(10, 20, 300, 280);
        btlVendedor.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
       ...
       public void desenharTelaNovo(){
        ...
        lblVendedor.setBounds(90, 10, 180, 22);
        painelNovo.add(lblVendedor);
        
        txtVendedor = new JTextField();
        txtVendedor.setBounds(90, 30, 170, 22);
        painelNovo.add(txtVendedor);
       ...
       painelNovo.add(btnCancelar);
        ...
        public model.VendedorModel getCadTabela_Vendedor(){
        
           vendedor= new VendedorModel(txtVendedor.getText());
