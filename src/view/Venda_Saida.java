...
public class Venda_Saida {
    ...
    private JTextField txtCliente, txtCodCliente,txtCI, txtProduto, txtCodProduto;
    ...
    private JLabel lblMotorista, lblPlaca, lblBonificacao,lblFrete,lblObservacao1, lblObservacao,lblDescontoVista, lblValorBonificacao,lblCodMotorista,lblFunRural;
    ...
    private JLabel lblDados, lblSacria, lblOutras, lblFreteDestino, lblDescarga, lblComissaoCultura, lblComissaoComercial, lblImposto;
    private JTextField txtSacaria, txtOutras, txtFreteDestino, txtDescarga, txtComissaoCultura, txtComissaoComercial, txtImposto;
 ...
 //-----------------------------------------------------------------------------------------//       
  ...
  //-----------------------------------------------------------------------------------------//
     ...
     private void criarTabelaSetor() {
        ...
        tblSetor.getColumnModel().getColumn(0).setPreferredWidth(140);
        tblSetor.getColumnModel().getColumn(1).setPreferredWidth(85);
        tblSetor.getColumnModel().getColumn(2).setPreferredWidth(85);
        tblSetor.getColumnModel().getColumn(3).setPreferredWidth(80);
      ...
      //------------------------------------------------------------------------//
        ...
        lblComissaoCultura = new JLabel("Comissão Cultura ");
        lblComissaoCultura.setBounds(50, 200, 120, 22);
        painelDados.add(lblComissaoCultura);
        
       
        txtComissaoCultura = new JTextField();
        txtComissaoCultura.setBounds(50, 220, 100, 22);
        painelDados.add(txtComissaoCultura);
        ...
        lblComissaoComercial = new JLabel("Comissão Comercial ");
        lblComissaoComercial.setBounds(50, 240, 140, 22);
        painelDados.add(lblComissaoComercial);
        
       
        txtComissaoComercial = new JTextField();
        txtComissaoComercial.setBounds(50, 260, 100, 22);
        painelDados.add(txtComissaoComercial);
        
        
          
          //------------------------------------------------------------------------//
      
        lblImposto = new JLabel("Imposto");
        lblImposto.setBounds(50, 280, 140, 22);
        painelDados.add(lblImposto);
        
       
        txtImposto = new JTextField();
        txtImposto.setBounds(50, 300, 100, 22);
        painelDados.add(txtImposto);
         ...
         //-------------------------------------------------------------------------------------------// 
        btnSair = new JButton("Sair");
       btnSair.setBounds(50, 335, 100, 27);       
       btnSair.setIcon(new ImageIcon("/Workspace/Maquina/src/Sistema/sair.png"));      
       btnSair.setHorizontalTextPosition(SwingConstants.RIGHT);
        btnSair.setFont(new Font("Arial", 1, 13));
